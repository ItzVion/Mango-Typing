...
async function bootstrap() {
  ...
  await exec(`CREATE TABLE IF NOT EXISTS "OtpToken" ("email" TEXT NOT NULL PRIMARY KEY,"token" TEXT NOT NULL,"expiresAt" DATETIME NOT NULL,"username" TEXT NOT NULL,"passwordHash" TEXT NOT NULL,"attempts" INTEGER NOT NULL DEFAULT 0,"lastSentAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP)`);
