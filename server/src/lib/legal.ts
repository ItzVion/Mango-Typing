...
export const DEFAULT_LEGAL: Record<string, string> = {
  privacy: `MangoTyping — Privacy Policy\nVersion: ${LEGAL_VERSION}\nLast updated: September 10, 2026\n\nWe may process account identifiers, email address, password hashes, profile information, typing history, donation/payment identifiers, IP addresses used for rate limiting and security, and information submitted in bug reports. Google sign-in may provide your Google identifier, email, name and profile image; we never receive your Google password. Razorpay processes payment details; MangoTyping stores only the payment/order identifiers, amount, status, timestamps and related account information needed for service and reconciliation.\n\nWe use information to provide the service, authenticate accounts, save typing history, prevent abuse and fraud, process donations, provide support, maintain security and reliability, and comply with law. We do not sell personal data or use it for targeted advertising. Authentication uses secure httpOnly cookies; non-sensitive preferences may use browser storage.\n\nService providers may include hosting/deployment providers, Turso/libSQL, Google, Razorpay, email/SMTP providers and configured support services. Providers may process information internationally. We retain information as reasonably necessary for account operation, security, support, transaction records and legal obligations. You may request deletion or other applicable rights by contacting support@mangotyping.fun; some records may need to remain for legal, payment, fraud-prevention or dispute-resolution purposes.\n\nMangoTyping does not use targeted advertising or behavioral profiling directed at children. Where applicable law requires verifiable parental or guardian consent, that consent must be obtained. We use reasonable security safeguards, but no internet service can guarantee absolute security. Material policy changes may require renewed consent where applicable.`,
